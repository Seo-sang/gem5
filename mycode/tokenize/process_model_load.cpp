#include "process_model_load.h"

int llama_vocab::find_bpe_rank(const std::string & token_left, const std::string & token_right) const {
#ifdef DEBUG
    printf("-find_bpe_rank start\n");
#endif
...
struct llm_tokenizer_spm {
    ...
    void tokenize(const std::string & text, std::vector<llama_vocab::id> & output) {
        ...
        //file
        /*
        std::ofstream wikifile("wiki_result.txt", std::ios::app);
        ...
        */
        ...
        queue_maxsize = std::max(queue_maxsize, (int)my_work_queue.size());

        //work queue에 bigram token들을 넣음
